...
public class InstitutionLoader extends AbstractStartupLoader {
	...
	public void createDemoDataUma() throws IOException {
        ...
        String streetAddressForUma = "{'addressLine':['Avenida Cervantes, 2'],'postalCode':'29016','locality':'Málaga','country':'ES'}";
        ...
        String factSheetInstitution = "{'url':[{'text':'https://www.uma.es','lang':'es'}],'contactDetails':{'streetAddress':" + streetAddressForUma + ",'url':" + websiteUrlForUma + ",'email':['info@uma.es'],'mailingAddress':{'postOfficeBox':'Avenida Cervantes, 2'},'phoneNumber':{'e164':'+34 952131000'},'faxNumber':{'e164':'+34 952131000'}}}";
        String courseCatalog = "[{'text':'https://www.uma.es','lang':'es'}]";
