...
/*@Entity
@NamedQueries({
    @NamedQuery(name = CooperationCondition_OLD.findAll, query = "SELECT c FROM CooperationCondition c"),
})*/
public class CooperationCondition_OLD implements Serializable{
/*
	...
	public List<LanguageSkill> getRecommendedLanguageSkill() {
    ...
    public boolean equals(Object obj) {
        ...
        final CooperationCondition_OLD other = (CooperationCondition_OLD) obj;
