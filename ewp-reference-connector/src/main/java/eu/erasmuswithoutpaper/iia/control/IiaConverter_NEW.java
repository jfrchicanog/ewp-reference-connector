...
import eu.erasmuswithoutpaper.iia.entity.CooperationCondition_NEW;
import eu.erasmuswithoutpaper.iia.entity.IiaContact_NEW;
...
import eu.erasmuswithoutpaper.iia.entity.Iia_NEW;
import eu.erasmuswithoutpaper.iia.entity.IiaPartner_NEW;
import eu.erasmuswithoutpaper.imobility.control.IncomingMobilityConverter;

public class IiaConverter_NEW {

    private static final Logger logger = LoggerFactory.getLogger(IncomingMobilityConverter.class);
/*
    public List<IiasGetResponse.Iia> convertToIias(List<Iia_NEW> iiaList) {
        return iiaList.stream().map((Iia_NEW iia) -> {
    ...
    private IiasGetResponse.Iia.Partner convertToPartner(IiaPartner_NEW partner) {
        if(partner == null) {
            return null;
        }
    ...
    private Contact convertToContact(IiaContact_NEW iiaContact) {
        if(iiaContact == null) {
            return null;
        }
    ...
    private IiasGetResponse.Iia.CooperationConditions convertToCooperationConditions(CooperationCondition_NEW cooperationCondition) {
