...
@XmlRootElement(name = "institutions", namespace = "https://github.com/erasmus-without-paper/ewp-specs-api-institutions/blob/stable-v2/manifest-entry.xsd")
public class Institutions
    extends ManifestApiEntryBase
    implements Serializable
{

    @XmlElement(name = "http-security", namespace = "https://github.com/erasmus-without-paper/ewp-specs-api-institutions/blob/stable-v2/manifest-entry.xsd")
    protected HttpSecurityOptions httpSecurity;
    @XmlElement(namespace = "https://github.com/erasmus-without-paper/ewp-specs-api-institutions/blob/stable-v2/manifest-entry.xsd", required = true)
    @XmlSchemaType(name = "anyURI")
    protected String url;
    @XmlElement(name = "max-hei-ids", namespace = "https://github.com/erasmus-without-paper/ewp-specs-api-institutions/blob/stable-v2/manifest-entry.xsd", required = true)
