...
@XmlRootElement(name = "omobility-las-index-response", namespace = "https://github.com/erasmus-without-paper/ewp-specs-api-omobility-las/blob/stable-v1/endpoints/index-response.xsd")
public class OmobilityLasIndexResponse
    implements Serializable
{

    @XmlElement(name = "omobility-id", namespace = "https://github.com/erasmus-without-paper/ewp-specs-api-omobility-las/blob/stable-v1/endpoints/index-response.xsd")
